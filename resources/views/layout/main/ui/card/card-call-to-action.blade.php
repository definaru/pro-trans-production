<div class="d-flex flex-row mb-3 bg-white rounded mb-5 shadow-sm">
    <div class="col-lg-5 col-12">
        <div class="d-flex flex-column gap-4 p-5">
            <div>
                <p class="text-secondary fs-6">Оригинальные запчасти / Доставка / УПД</p>
    ...
    <div class="col-lg-7 col-12">
        <img src="/img/photo50.jpg" alt="image" class="w-100 h-100 rounded-end object-fit-cover" />
    </div>
</div>