new Vue({
    ...
    methods: {
        ...
        async Authorisation() {
            ...
            //console.log('moysklad', this.moysklad);
        ...
        async addCompany(uuid) {
            ...
            if(this.result) {
                const {kpp, name, inn, ogrn, management, okved, address, ogrn_date} = this.result.data
                var formdata = new FormData();
                formdata.append('uuid', uuid);
                formdata.append('superintendant', management?.name ?? '');
        ...
        async addUser(uuid) {
            ...
            const {management} = this.result?.data
            ...
            if(this.result) {
                var formdata = new FormData();
                formdata.append('name', management?.name ?? '');
        ...
        async getDataCompany()
        {
            if(this.result && this.user) {
                const {kpp, name, inn, ogrn, okpo, address} = this.result?.data
            ...
            console.log('MS connect', Boolean(this.moysklad))
...
document.querySelector('input[name="email"]').value = currentemail;
