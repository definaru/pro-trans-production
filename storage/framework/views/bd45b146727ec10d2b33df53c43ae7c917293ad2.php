...
<?php $__env->startSection('title', 'Заказ #'.$data['deal']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Button::class, ['type' => 'a','size' => 'sm','color' => 'danger','href' => '/dashboard/payment/order/'.e($data['invoicesOut']['id']).'','text' => 'Запросить счёт','icon' => 'credit_score']); ?>
        ...
        <div class="card border-0 shadow-sm mb-3 mb-lg-5">
            <div class="card-header border-light bg-white d-flex align-items-center justify-content-between">
                <h5 class="fw-bold mb-0 mt-1">
                    ...
                    <?php echo e($data['positions']['size']); ?>
            ...
            <div class="card-body">
                <?php $__currentLoopData = $data['positions']['product']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <div class="row">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <a href="/dashboard/product/details/<?php echo e($product['id']); ?>" class="h6 text-dark m-0 d-block text-decoration-none">
                                ...
                                <div class="fs-6 text-secondary">
                                    ...
                                    <span>
                                        <?php echo e($product['product']['article']); ?>
                ...
                <div class="row justify-content-md-end">
                    <div class="col-lg-9">
                        <dl class="row text-sm-end m-0">
                            ...
                            <dd class="col-sm-6 fw-bold">
                                <?php echo number_format(($data['invoicedSum']) / 100, 2, '.', ' ') ?> ₽
                            </dd>
                        </dl>
                    </div>
                </div>
            ...
            <div class="card-body px-0 pb-2">
                <ul class="list-group list-group-flush list-group-no-gutters">
                    ...
                    <li class="list-group-item">
                        ...
                        <?php echo e($data['company']['actualAddress']); ?>
                    ...
                    <li class="list-group-item">
                        ...
                        <small class="d-block text-muted">
                        <?php echo e($data['company']['address']); ?>
                        ...
                        <div class="mt-3">
                            ...
                            <?php if (isset($component)) { $__componentOriginal065ae5da12ba8e75c6b4e84d90798c2fb812b940 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Button::class, ['type' => 'a','href' => '#','color' => 'dark','text' => 'связаться с менеджером','icon' => 'headset_mic']); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
