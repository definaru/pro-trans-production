...
<?php $__env->startSection('title', $order === '' ? 'Счета' : 'Счет покупателю №'.$order['order']['name']); ?>
        ...
        <div class="card border-0 shadow-sm card-lg mb-5">
                ...
                <div class="row justify-content-lg-between">
                    ...
                    <div class="col-sm-auto order-1 order-sm-2 text-sm-end mb-3">
                        <div class="mb-3">
                            <h2>
                                <a 
                                    href="/dashboard/payment/reports/<?php echo e($invoiceout[6]); ?>" 
                                    class="text-decoration-none" 
                                    data-bs-toggle="tooltip" 
                                    title="Перейти к отчету"
                                >
                                    #<?php echo e($order['order']['name']); ?>
            ...
            <div class="row justify-content-md-between mb-3">
                <div class="col-md">
                    ...
                    <h5><?php echo e($order['company']['name']); ?></h5>
                    <!-- <h5><?php if($user->customer->superintendant): ?> <?php echo e($user->customer->superintendant); ?> <?php else: ?> Нет данных <?php endif; ?></h5>  -->
                    <address class="row text-muted">
                        <div class="col-6">
                            <!-- <?php if($user->customer->address): ?> <?php echo e($user->customer->address); ?> <?php else: ?> Нет данных <?php endif; ?> -->
                            <?php echo e($order['company']['address']); ?>
                ...
                <div class="col-md text-md-end">
                    <dl class="row">
                        ...
                        <dd class="col-sm-4"><?php echo e(date_format(date_create($order['order']['updated']), 'd/m/Y')); ?></dd>
                        
                    </dl> 
                    <dl class="row">
                        <dt class="col-sm-8">Срок оплаты:</dt> 
                        <dd class="col-sm-4"><?php echo e(date_format(date_create($order['order']['moment']), 'd/m/Y')); ?></dd>
                    </dl>
                </div>
            </div> 
            <div class="table-responsive">
                <table class="table table-borderless table-nowrap table-align-middle">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $order['invoice']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-bottom border-light">
                            <td><?php echo e($loop->iteration); ?></td> 
                            <th>
                                <div>
                                    <span class="me-2"><?php echo e($invoice['product']['article']); ?></span>
                                    <span class="fw-light"><?php echo e($invoice['product']['name']); ?></span>
                                </div>
                            </th>
            ...
            <div class="row justify-content-md-end mb-3">
                ...
                <div class="col-md-8 col-lg-7">
                    <dl class="row text-sm-end">
                        ...
                        <dd class="col-sm-6">
                            <?php echo number_format(($order['order']['sum']) / 100, 2, '.', ' ') ?> ₽
                        </dd> 
                        <dt class="col-sm-6 text-muted">Кол-во:</dt> 
                        <dd class="col-sm-6"><?php echo e($order['order']['positions']['meta']['size']); ?></dd> 
                        <dt class="col-sm-6 text-muted">НДС:</dt> 
                        <dd class="col-sm-6">
                            <?php echo number_format(($order['order']['vatSum']) / 100, 2, '.', ' ') ?> ₽
                        </dd> 
