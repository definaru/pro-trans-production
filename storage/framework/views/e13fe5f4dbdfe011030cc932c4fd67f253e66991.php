...
<form action="/login" method="post" class="mt-4">
    ...
    <div class="mt-2">
        <div class="input-group">
            <span class="input-group-text border-end-0 bg-white <?php $__errorArgs = ['email'];
...
<?php echo $__env->make('layout/auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\prospektrans.host\resources\views/signin.blade.php ENDPATH**/ ?>