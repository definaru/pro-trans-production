        ...
        <form action="" method="post" class="card shadow-sm border-0">
            ...
            <div class="card-body">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control" name="id" value="<?php echo e($id); ?>" />
                </div>
                <div class="mb-2">
        ...
        <div class="card-body">
            <div class="row mt-3">
                <div class="col-md-3">
                    ...
                    <?php if (isset($component)) { $__componentOriginal065ae5da12ba8e75c6b4e84d90798c2fb812b940 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Button::class, ['type' => 'a','href' => '#','color' => 'dark','text' => 'В корзину','icon' => 'shopping_cart']); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?>
                ...
                <div class="col-md-9">
                    ...
                    <p class="mb-1">
                        <b>Внешний код:</b>
                        <?php echo e($product['externalCode']); ?>
                    ...
                    <!-- <p class="mb-1">
                        <b>Мин. цена:</b>
                        <?php echo number_format(($product['minPrice']) / 100, 2, '.', ' ') ?> ₽
                    </p> -->
                    <p class="mb-1">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold m-0">ID <?php echo e($product['paymentItemType']); ?>а:</label>
                        <input type="text" name="id" class="form-control" value="<?php echo e($product['id']); ?>" placeholder="Идентификатор..." />
