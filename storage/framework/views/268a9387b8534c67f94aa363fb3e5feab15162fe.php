...
<?php endif; ?>
    ...
    <?php if($contract['state']['name'] === 'Не заключён'): ?>
    <div class="d-flex align-items-center row mt-4">
        <div class="col-12 col-lg-5 d-flex gap-3">
            <form action="/dashboard/action/deal" method="post">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="deal" value="<?php echo e($contract['state']['id']); ?>" />
                <input type="hidden" name="accountId" value="<?php echo e($contract['state']['accountId']); ?>" />
