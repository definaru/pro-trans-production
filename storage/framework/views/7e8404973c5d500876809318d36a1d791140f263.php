...
<body>
                ...
                <div class="col-md-4 offset-md-4 py-5">
                    ...
                    <div class="text-center text-muted mt-2">
                        <small>
                            ...
                            Свяжитесь с нами <?php echo e($contact::format_phone(config('app.phone'))); ?> <br />
                            <a 
                                href="/contact" 
    ...
    <script src="<?php echo e(asset('js/defina.min.js')); ?>"></script>
</body>
</html><?php /**PATH C:\OpenServer\domains\prospektrans.host\resources\views/layout/auth.blade.php ENDPATH**/ ?>