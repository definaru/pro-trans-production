...
<?php $__env->startSection('title', $catalog['name']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\ProductCard::class, ['image' => $item['images']['rows'],'href' => ''.e($item['id']).'','name' => ''.e($item['name']).'','vendorcode' => ''.e($item['code']).'','price' => ''.e($item['salePrices'][0]['value']).'','availability' => ''.e($item['quantity']).'','modifications' => $name]); ?>
